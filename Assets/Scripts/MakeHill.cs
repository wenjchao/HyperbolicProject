...
public class MakeHill : MonoBehaviour
{
    Mesh mesh;
    ...
    void Initial()
    {
        ...
        for ( int i = 0 ; i <= circularnum ; i++ ){
            ...
            for( int j = 0 ; j <= depthnum ; j++ ){
                ...
                vertices[ i*( depthnum+1 ) + j ] = new Vector3( (outercircle - tempsinj*(outercircle-innercircle) ) *tempcosi , depth*tempcosj , (outercircle - tempsinj*(outercircle-innercircle) ) *tempsini );
            }
        }
